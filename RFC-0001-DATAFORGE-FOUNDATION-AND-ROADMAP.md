...
5. Implementar SQLite y migración inicial.
6. Implementar máquina de estados.
7. Implementar ledger mínimo.
8. Implementar CLI project create/status.
9. Implementar UI create/open/status usando df-facade.
10. Ejecutar fmt, clippy, tests y build.

...
| 7 | Medir sweep de `execute` + documentar en `m1.0.1-results.md` + PR de borrador | ◐ parcial — sweep de `execute --workers` medido (corpus A 40k): ~2,0× saturando en 4 workers, correctitud verificada (45.003 ops, 0 fallos); documentado en `m1.0.1-results.md` y ADR-0048. Un bug real de terminación temprana se encontró y arregló aquí. Falta: incluir en la PR borrador |

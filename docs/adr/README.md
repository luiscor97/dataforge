...
| [ADR-0046](ADR-0046-bounded-parallel-hash-and-verify.md) | Hash y verificación paralelos acotados (M1.0.1) | Aceptada |
| [ADR-0047](ADR-0047-strict-parallel-execution.md) | Ejecución estricta paralela (M1.0.1) | Aceptada |
